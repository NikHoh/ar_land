#ifndef TRACK_TRAJECTORY_PLANNER_NODE_H
#define TRACK_TRAJECTORY_PLANNER_NODE_H
...
class track_trajectory_planner_node
{
public:
  track_trajectory_planner_node();
  ros::NodeHandle nh;
...
#endif // TRACK_TRAJECTORY_PLANNER_NODE_H
